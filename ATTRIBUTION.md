...
- **D&D 5e (2014)** rules data derives from the **System Reference Document 5.1**
  ("SRD 5.1"), © Wizards of the Coast LLC, licensed under
  [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/legalcode).
- **D&D 5.5e (2024)** rules data derives from the **System Reference Document 5.2.1**
  ("SRD 5.2.1"), © Wizards of the Coast LLC, licensed under
  [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/legalcode).

Charnik ships **SRD content only**. No Product Identity, no non-SRD material is bundled.
